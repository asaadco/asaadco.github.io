...
- [ ] **Phase 1: Foundation and Deployment Pipeline** - Proven Astro scaffold deploys to GitHub Pages live URL
...
|---|-------|------|--------------|-------|
| 1 | Foundation and Deployment Pipeline | Astro project scaffolded with correct GitHub Pages config and CI/CD pipeline proven working before any UI is built | SITE-01 | TBD |
...
**Success Criteria** (what must be TRUE):
  ...
  3. The live GitHub Pages URL (`https://neoasaad.github.io/Asaad_Webpage`) loads the placeholder page with no 404 asset errors
  4. `astro.config.mjs` has `site`, `base: /Asaad_Webpage`, and `output: static` set correctly
**Plans:** TBD
**UI hint**: no
...
|-------|----------------|--------|-----------|
| 1. Foundation and Deployment Pipeline | 0/? | Not started | - |
